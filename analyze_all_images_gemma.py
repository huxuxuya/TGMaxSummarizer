#!/usr/bin/env python3
"""
Скрипт для анализа всех скачанных изображений с помощью gemma3:27b
"""
...
def find_all_images(images_dir: str = "images") -> list:
...
async def analyze_all_images(max_images: int = None):
...
async def main():
    """Основная функция"""
    logger.info("🖼️ Анализатор всех скачанных изображений с gemma3:27b")
    logger.info("=" * 60)
    ...
    # Запускаем анализ
    await analyze_all_images(max_images)
